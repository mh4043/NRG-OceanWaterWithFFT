...
async function startWebGPU(){
    ...
    const viewMatrixUniform = vsUniformValues.subarray(0, 16);
    const projectionMatrixUniform = vsUniformValues.subarray(16, 32);
    const fsUniformValues = new Float32Array(2 * 3);  // 2 vec3fs
    const cameraPositionUniform = fsUniformValues.subarray(0, 3);
